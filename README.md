...
登録ボタン：名前、年齢、性別を入力して、登録ボタンをクリックすると、顧客テーブルにレコードが登録されます。  
編集ボタン：ID、名前、年齢、性別を入力し、編集ボタンをクリックすると、指定したIDのレコードを編集できます。  
削除ボタン：IDを入力して削除ボタンをクリックすると、指定したレコードを削除できます。  
クリアボタン：名前、年齢、性別を入力した状態でクリアボタンをクリックすると、入力データがクリアされます。  
